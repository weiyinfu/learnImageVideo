...
vio.vwrite('why.mp4', a, verbosity=True)
time.sleep(3)
"""
 ffmpeg -y -hide_banner -loglevel error -r 30 -f rawvideo -pix_fmt rgb24 -s 480x680 -i - a.mp4
 
 ffmpeg -y -r 20 -f rawvideo -pix_fmt rgb24 -s 300x300 -i - a.mp4
 
 ffmpeg -y -f rawvideo -pix_fmt rgb24 -s 680x480 -i - why.mp4
"""
